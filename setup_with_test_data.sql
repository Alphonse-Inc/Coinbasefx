-- Complete setup script for Crypto Trading Platform with test data
-- This script creates the database, tables, and adds test users for easy testing
...
-- Test User 2: Admin user with higher privileges
INSERT INTO users (
    username, 
    full_name, 
    email, 
...
SELECT 'Test users have been created with the following credentials:' AS info;
SELECT 'Username: testuser | Password: password | Status: Verified' AS test_user_1;
SELECT 'Username: admin | Password: password | Status: Verified' AS test_user_2;
SELECT 'Username: unverified | Password: password | Status: Unverified' AS test_user_3;